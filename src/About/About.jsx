...
export default function About() {
  ...
  {
    let {data} = await Axios.get(`https://api.themoviedb.org/3/discover/movie?api_key=68e77521cfd3cb1f427d0ba6fe08a6c7&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=9&with_watch_monetization_types=flatrate`);
